                  ...
                  <input type="text" name="name"value="{{$model->name}}" class="form-control" placeholder="">
                    ...
                    <select name="cate_id" class="form-control">
                        @foreach ($cars as $item)
                            <option @if($item->id == $model->car_id) selected @endif value="{{$item->id}}">{{$item->name}}</option>
                        @endforeach
                    </select>
                  </div>
                  <div class="form-group">
                    <label for="">travel_time</label>
                    <input type="text" name="travel_time" value="{{$model->travel_time}}" class="form-control" placeholder="">
                  </div>
                <div class="form-group">
